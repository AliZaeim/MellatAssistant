...
namespace Web.Areas.UsersPanel.Controllers
{
    ...
    public class InstagramsController : Controller
    {
        ...
        // GET: UsersPanel/Instagrams
        public async Task<IActionResult> Index()
        {
            return View(await _instaService.GetAllAsync());
        }

        // GET: UsersPanel/Instagrams/Details/5
        ...
        // GET: UsersPanel/Instagrams/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: UsersPanel/Instagrams/Create
        ...
        // GET: UsersPanel/Instagrams/Edit/5
        ...
        // POST: UsersPanel/Instagrams/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: UsersPanel/Instagrams/Delete/5
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            Instagram instagram = await _instaService.GetByIdAsync((int)id);
            if (instagram == null)
            {
                return NotFound();
            }
        ...
        // POST: UsersPanel/Instagrams/Delete/5
