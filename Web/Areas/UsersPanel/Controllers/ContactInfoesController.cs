...
namespace Web.Areas.UsersPanel.Controllers
{
    ...
    public class ContactInfoesController : Controller
    {
        ...
        // GET: UsersPanel/ContactInfoes
        public async Task<IActionResult> Index()
        {
            return View(await _genericService.GetAllAsync());
        }

        // GET: UsersPanel/ContactInfoes/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ContactInfo contactInfo = await _genericService.GetByIdAsync((int)id);
            return contactInfo == null ? NotFound() : View(contactInfo);
        }
        // GET: UsersPanel/ContactInfoes/Create
        public IActionResult Create()
        {
            return View();
        }
        // POST: UsersPanel/ContactInfoes/Create
        ...
        // GET: UsersPanel/ContactInfoes/Edit/5
        ...
        // POST: UsersPanel/ContactInfoes/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        //// GET: UsersPanel/ContactInfoes/Delete/5
